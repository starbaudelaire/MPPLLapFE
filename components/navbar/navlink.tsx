...
const Navlink = () => {
  ...
  return (
    <>
      ...
      >
        <ul className="flex flex-col font-semibold text-sm uppercase p-4 mt-2 rounded-sm bg-gray-50 md:flex-row md:items-center md:space-x-10 md:p-0 md:mt-0 md:border-0 md:bg-white">
          <li>
            <Link
              href="/"
