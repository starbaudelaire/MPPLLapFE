// components/admin/field/edit-field-form-client.tsx
"use client";

import { useRef, useState, useTransition } from "react";
import { updateField } from "@/lib/action"; // Akan dibuat nanti
import { type putBlobResult } from "@vercel/blob";
import { IoCloudUploadOutline, IoTrashOutline } from "react-icons/io5";
import Image from "next/image";
import { Amenities, SportType } from "@/app/generated/prisma/client"; // Import type prisma
import clsx from "clsx";
import { useActionState } from "react";

type EditFieldFormClientProps = {
  field: any; // Sesuaikan dengan type field Anda
  amenities: Amenities[];
};

const EditFieldFormClient = ({ field, amenities }: EditFieldFormClientProps) => {
  ...
  const [state, formAction, isPending] = useActionState(
    updateField.bind(null, field.id, field.image),
    null
  );
      ...
      <div className="grid md:grid-cols-12 gap-5">
        <div className="col-span-8">
          ...
          <div className="mb-4 grid md:grid-cols-3">
            {/* Menampilkan semua amenities dan menandai yang sudah dipilih */}
            {amenities?.map((item: Amenities) => (
              <div className="flex items-center mb-4" key={item.id}>
                <input
                  ...
                  defaultChecked={field.amenities.some((a: any) => a.id === item.id)}
        ...
        <div className="col-span-4">
          ...
          <div className="mb-4">
            <input
              type="text"
              name="capacity"
              defaultValue={field.capacity.toString()}
              className="py-2 px-4 rounded-sm border border-gray-400 w-full"
          ...
          <div className="mb-4">
            <input
              type="text"
              name="pricePerHour"
              defaultValue={field.pricePerHour.toString()}
              className="py-2 px-4 rounded-sm border border-gray-400 w-full"
...
export default EditFieldFormClient;