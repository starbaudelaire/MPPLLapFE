  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-end mb-8">
        <div>
           <h1 className="text-2xl font-bold text-gray-800">Application Revenue History 💰</h1>
           <p className="text-gray-500">Breakdown pendapatan bersih aplikasi (Fee 10% + Kode Unik)</p>
        </div>
                    ...
                    history.map((item, index) => (
                        <tr key={item.id} className="hover:bg-gray-50 transition">
                            ...
                            <td className="px-6 py-4">
                                <div className="font-bold text-gray-800">#{item.bookingCode}</div>
                                <div className="text-xs text-gray-500">{item.user}</div>
                                <div className="text-[10px] text-gray-400">{item.userEmail}</div>
                            </td>
